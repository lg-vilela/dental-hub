...
const SubscriptionModal: React.FC<SubscriptionModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in p-4">
            <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-lg shadow-2xl border border-slate-100 dark:border-slate-800 max-h-[90vh] flex flex-col">
                ...
                <div className="p-6 overflow-y-auto space-y-6">
                    {/* Active Plan Card */}
                    <div className="bg-gradient-to-br from-[#617FA3] to-[#4A6280] rounded-xl p-5 text-white shadow-lg shadow-[#617FA3]/20 relative overflow-hidden shrink-0">
                        ...
                        <div className="relative z-10">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-xs font-bold whitespace-nowrap">Ativo</span>
                            </div>
                    ...
                    {/* Actions */}
                    <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex flex-col gap-3 shrink-0">
