                        ...
                        <div className="relative">
                            ...
                            {userMenuOpen === 'user' && (
                                <div className="absolute right-0 top-14 w-64 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                                    ...
                                    <button onClick={() => useAuth().signOut()} className="w-full text-left px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 hover:text-red-700 font-bold flex items-center gap-3">
